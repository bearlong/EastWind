...
export default function classDetail() {
  ...
  return (
    ...
    /> */}
        ...
        <div className="detailpic-aa">
          <div className="detailpic1-aa">
            <div className="depic1-aa">
              <img
        ...
        <div className="detextgroup-aa">
          <div className="texth2detail3-aa">
            <div className="texth2detail31-aa">
        ...
        <div className="detextgroup-aa" style={{ paddingBottom: '3rem' }}>
          <div className="texth2detail3-aa">
            <div className="texth2detail31-aa">
              <h4>想學程式？推薦你從 麻將 開始！</h4>
            </div>
