...
import UserBasicInfoForm from '@/components/user/user-basic-info-form'
import UserImageUpload from '@/components/user/user-image-upload'
import UserDetailInfoForm from '@/components/user/user-detail-info-form'
